...
pdf("NeuronalMarkers.pdf",paper = "a4",height = 5,width = 7)
TSNEPlot(NeuronalClustering, pt.size =1)
for (gene in  c("tag-80", "cab-1", "ida-1", "pgal-1", "sbt-1", "unc-80", "pghm-1", "unc-2", "unc-13")) {
  print(FeaturePlot(NeuronalClustering,features = gene))
}
